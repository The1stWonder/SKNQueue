...
namespace MasterQ
{
    public partial class Service20Page : ContentPage
    {
        ...
        public Service service17 = new Service();
        public Service service18 = new Service();
        public Service service19 = new Service();
        public Service service20 = new Service();

        public Service20Page()
        {
            InitializeComponent();
        ...
        public void getService()
        {
            ...
            service18 = Service[17];
            service19 = Service[18];
            service20 = Service[19];
            ...
            text_service18.Text = service18.serviceName;
            text_service19.Text = service19.serviceName;
            text_service20.Text = service20.serviceName;
            ...
            btn_service18.IsEnabled = true;
            text_service18.IsEnabled = true;
            btn_service19.IsEnabled = true;
            text_service19.IsEnabled = true;
            btn_service20.IsEnabled = true;
            text_service20.IsEnabled = true;
        }
        ...
        public void OnService18(object sender, System.EventArgs args)
        {
            btn_service18.IsEnabled = false;
            text_service18.IsEnabled = false;
            App.servicename = service18.serviceName;
            ...
            UIReturn uiReturn = BranchActionsController.getInstance().reserveQueueBranch(service18);
            if (uiReturn.isSuccess)
            {
                BranchSessionModel.bookingQ = (Queue)uiReturn.returnObject;
                if (BranchSessionModel.bookingQ != null)
        ...
        public void OnService19(object sender, System.EventArgs args)
        {
            btn_service19.IsEnabled = false;
            text_service19.IsEnabled = false;
            App.servicename = service19.serviceName;
            ...
            UIReturn uiReturn = BranchActionsController.getInstance().reserveQueueBranch(service19);
            if (uiReturn.isSuccess)
            {
                BranchSessionModel.bookingQ = (Queue)uiReturn.returnObject;
                if (BranchSessionModel.bookingQ != null)
        ...
        public void OnService20(object sender, System.EventArgs args)
        {
            btn_service20.IsEnabled = false;
            text_service20.IsEnabled = false;
            App.servicename = service20.serviceName;
            ...
            UIReturn uiReturn = BranchActionsController.getInstance().reserveQueueBranch(service20);
            if (uiReturn.isSuccess)
            {
                BranchSessionModel.bookingQ = (Queue)uiReturn.returnObject;
                if (BranchSessionModel.bookingQ != null)
